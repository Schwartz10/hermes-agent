...
def finalize_turn(
    ...
    *,
    ...
    _close_steer_window_and_drain = getattr(agent, "_close_steer_window_and_drain", None)
    if callable(_close_steer_window_and_drain):
        _leftover_steer = _close_steer_window_and_drain()
    else:
